...
const editTask = function() {
    ...
    const editInput = listItem.querySelector('.todo-app__task');
    const label = listItem.querySelector('.todo-app__label');
    const editBtn = listItem.querySelector('.todo-app__edit-btn');
    const containsClass = listItem.classList.contains('todo-app__item--edit');
